...
// POST /api/book
// ADD THIS ROUTE RIGHT BELOW YOUR /api/book ROUTE
app.post('/api/contact', async (req, res) => {
    // This forwards the exact same form data to the exact same logic!
    const body = req.body || {};
    const {
        applianceType,
        customApplianceType,
    ...
    try {
        ...
        const applianceName = `${brand === 'Other' ? (customBrand || 'Unknown') : brand} ${applianceType === 'Other' ? customApplianceType || 'Appliance' : applianceType}`.trim();
