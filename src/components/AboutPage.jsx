            ...
            <div style={{ display: 'flex', gap: '80px', alignItems: 'center', flexWrap: 'wrap-reverse' }}>
              <div style={{ flex: '1', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', minWidth: '320px' }}>
                ...
                <div style={{ ...cardStyle, padding: '30px', background: colors.lightSlate }}>
                  ...
                  <h4 style={{ fontWeight: '800', marginBottom: '12px', color: colors.white }}>Precision Tools</h4>
              ...
              <div style={{ flex: '1', minWidth: '320px' }}>
                ...
                <ul style={{ listStyle: 'none', padding: 0 }}>
                  {[
                    ...
                    <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px', fontWeight: '600', color: colors.slate }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
              {[
                ...
                <div key={idx} style={{
                  ...
                  <h3 style={{ fontSize: '1.4rem', fontWeight: '800', marginBottom: '16px', color: colors.navy }}>{value.title}</h3>
                  <p style={{ color: colors.navy, lineHeight: '1.6' }}>{value.desc}</p>
                </div>
              ))}
            </div>
          </div>
